...
import type { HomeCardSkeletonProps } from '@/features/home/types';
...
const HomeCardSkeleton = ({ rows = 4, withSeeMore = true }: HomeCardSkeletonProps) => (
  <>
    {Array.from({ length: rows }).map((_, index) => (
      <StyledSkeletonCard key={`home-skeleton-${index}`} variant="outlined">
